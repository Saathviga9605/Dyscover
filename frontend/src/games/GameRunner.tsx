...
import { CalibrationOverlay, GazeConsentCard, toGazeBatchPayload, useGazeTracking } from '../gaze';
...
export function GameRunner() {
  ...
  if (calibrationOpen) return <CalibrationOverlay onFinished={finishCalibration} onCancel={() => { gaze.disable(); setCalibrationOpen(false); }} onCapturePoint={async (x, y) => { await gaze.setCalibrationPoint(x, y); }} />;
